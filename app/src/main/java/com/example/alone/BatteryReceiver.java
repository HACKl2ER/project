...
public class BatteryReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //Button statusLabel = ((Main_Page)context).findViewById(R.id.button2);
        TextView percentageLabel = ((Home)context).findViewById(R.id.percentageLabel);
        ImageView batteryImage = ((Home)context).findViewById(R.id.batteryImage);
